...
class UnifiedSynthWorklet extends AudioWorkletProcessor {
  static get parameterDescriptors() {
    return [
      ...
      { name: "frequency_start", defaultValue: 440, automationRate: "k-rate" },
      { name: "zingMorph_start", defaultValue: 0, automationRate: "k-rate" },
      { name: "zingAmount_start", defaultValue: 0, automationRate: "k-rate" },
      ...
      { name: "frequency_end", defaultValue: 440, automationRate: "k-rate" },
      { name: "zingMorph_end", defaultValue: 0, automationRate: "k-rate" },
      { name: "zingAmount_end", defaultValue: 0, automationRate: "k-rate" },
