...
class VoiceWorkletProcessor extends AudioWorkletProcessor {
    static get parameterDescriptors() {
        return [
            ...
            { name: 'frequency_in', defaultValue: 220, minValue: 20, maxValue: 2000, automationRate: 'k-rate' },
            { name: 'vowelX_in', defaultValue: 0.5, minValue: 0, maxValue: 1, automationRate: 'k-rate' },
            { name: 'vowelY_in', defaultValue: 0.5, minValue: 0, maxValue: 1, automationRate: 'k-rate' },
            { name: 'zingAmount_in', defaultValue: 0.5, minValue: 0, maxValue: 1, automationRate: 'a-rate' },
            { name: 'zingMorph_in', defaultValue: 0.5, minValue: 0, maxValue: 1, automationRate: 'a-rate' },
            { name: 'symmetry_in', defaultValue: 0.5, minValue: 0, maxValue: 1, automationRate: 'a-rate' },
            { name: 'amplitude_in', defaultValue: 0, minValue: 0, maxValue: 1, automationRate: 'k-rate' },
    ...
    process(inputs, outputs, parameters) {
        ...
        for (let sample = 0; sample < blockSize; sample++) {
            ...
            const { total: formantOutput, f1: formantF1, f2: formantF2, f3: formantF3 } = this.generateFormantSynthesis(this.masterPhase, modulator, symmetryArray[sample]);
